const MenuContent = `
        ...
        <div class="col-12">
          <div class="container">
            ...
            <h1 class="logo">
              <a href="#" class="logo_L"><img src="./images/pavilion/logo.png" alt="" /></a>
              <a href="#" class="logo_S"><img src="./images/pavilion/logo.png" alt="" /></a>
            </h1>
          ...
          <nav class="navigation have_language">
                    ...
                    <ul>
                        <li><a href="#"><img src="./images/pavilion/nav_img.png" alt="">首頁</a></li>
                        <li><a href="#">網站導覽</a></li>
                        <li><a href="#">聯絡我們</a></li>
                    </ul>
